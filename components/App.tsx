...
import { Sparkles, ScanSearch, ChevronLeft, LayoutGrid, ArrowRight, ExternalLink } from 'lucide-react';
import { 
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans transition-colors duration-300 relative">
      ...
      <main className="flex-grow w-full pt-24 md:pt-32 pb-20">
        ...
        {!showDashboard ? (
          <LandingPage onStart={() => setShowDashboard(true)} platform={platform} />
        ) : (
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 animate-in fade-in duration-500">
            ...
            {/* Content Area */}
            {!activeTool ? (
              <ToolGrid onSelectTool={setActiveTool} currentPlatform={platform} />
            ) : (
